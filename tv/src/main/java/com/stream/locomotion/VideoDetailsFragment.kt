...
class VideoDetailsFragment : DetailsSupportFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedMovie = IntentCompat.getSerializableExtra(requireActivity().intent, DetailsActivity.MOVIE, Movie::class.java)
        ...
        override fun onItemClicked(
            ...
            if (item is Movie) {
                ...
                intent.putExtra(resources.getString(R.string.movie), mSelectedMovie)
                                ...
                                val shared = (itemViewHolder?.view as? ImageCardView)?.mainImageView ?: itemViewHolder?.view ?: return
                val bundle =
